...
const About = () => {
  return (
    <div className="min-h-screen px-5 py-14 sm:py-20">
      <div className="max-w-2xl mx-auto">
        {/* Header */}
        <div className="text-center mb-14">
          <span className="text-[11px] tracking-[0.3em] uppercase text-ed-accent font-sans-ui font-medium">
            About
          </span>
          <h1 className="font-display text-4xl sm:text-5xl text-ed-text mt-4 tracking-tight">
            The Creator
          </h1>
        </div>
        ...
        <div className="flex flex-col items-center mb-12">
          <img
            className="w-24 h-24 sm:w-28 sm:h-28 rounded-full object-cover border-2 border-ed-border"
            src={pfp}
            alt="Rishi Raj"
          />
          <div className="text-center mt-6">
            <h2 className="font-display text-2xl sm:text-3xl text-ed-text tracking-tight">
              Rishi Raj
            </h2>
            <p className="text-ed-text-secondary font-body mt-1 text-lg">
        ...
        {/* Bio */}
        <div className="space-y-5 font-body text-ed-text-secondary text-base sm:text-[17px] leading-relaxed">
          <p>
          ...
          <p>
            Currently, I build projects and develop my skills&mdash;designing UI
        ...
        <div className="mt-12 pt-8 border-t border-ed-border">
          <h3 className="text-[11px] tracking-[0.3em] uppercase text-ed-text-tertiary font-sans-ui font-medium mb-6">
            Connect
          </h3>
          <ul className="space-y-4">
            <li>
              <a
                className="flex items-center gap-3 text-ed-text-secondary hover:text-ed-accent transition-colors duration-200 font-body"
