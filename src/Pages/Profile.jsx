...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const response = await fetch("https://bable-backend.vercel.app/user/details", {
          method: "GET",
          credentials: "include",
        });
  ...
  const handledeletefromwritten = async (blogid) => {
    try {
      const response = await fetch(`https://bable-backend.vercel.app/blog/delete/${blogid}`, {
        method: "POST",
        credentials: "include",
      });
  ...
  const handledeletefromsaved = async (blogid) => {
    try {
      const response = await fetch(`https://bable-backend.vercel.app/blog/remove/${blogid}`, {
        method: "POST",
        credentials: "include",
      });
